...
NUMERIC_INVARIANTS: tuple[tuple[str, Any, tuple[str, ...]], ...] = (
    ("schema_version", "2026-09-06.4", ("2026-09-06.4",)),
    ("prompt_expected_schema_version", "2026-09-06.4", ("2026-09-06.4",)),
    ...
    ("min_dte", 2, ("**2–7 DTE** hard range",)),
    ("max_dte", 7, ("**2–7 inclusive**",)),
    ("max_new_entries_per_day", 2, ("`new_entries_today` ≥ **2**",)),
    ("stop_after_losing_trades", 2, ("`losing_trades_today` ≥ **2**",)),
    ...
    ("option_quote.min_volume", 100, ("Contract volume ≥ **100**",)),
    ("option_quote.min_open_interest", 500, ("Open interest ≥ **500**",)),
    ...
    ("patterns.breakout_volume_lookback_completed_10m", 20, ("preceding **20 completed** current-session 10-minute candles",)),
    ("patterns.triangle_flat_slope_frac", 0.15, ("0.15 × (max(side) − min(side)) / window_bars",)),
    ...
    ("patterns.max_pattern_bars_day", 60, ("60 completed daily bars",)),
    ("patterns.max_pattern_bars_hour", 40, ("40 completed hour bars",)),
