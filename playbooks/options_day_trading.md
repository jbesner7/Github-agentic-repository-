...
**Status: RELEASED** (owner approved 2026-08-30), with **2026-09-06.6 Agent H live-safety locks** (`schema_version` 2026-09-06.6).
...
- H lease, continuity, Git-independent single closer, and the `INV[key]=value` registry: follow `playbooks/agent_h_autonomous.PROMPT.md`. Do not keep a second copy here.
