...
- Intraday graphs: live quote + **1-minute / 3-minute / 5-minute**. 1m and 5m are native RH intervals (`minute`, `5minute`). 3m is aggregated from 1m (`pipeline.bars.aggregate_to_minutes`). No `15minute`.
