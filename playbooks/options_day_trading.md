...
- H lease, continuity, emergency Git-outage path, and the `INV[key]=value` registry: follow `playbooks/agent_h_autonomous.PROMPT.md`. Do not keep a second copy here.
