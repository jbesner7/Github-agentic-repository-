...
Canonical rules: `config/rules.json` → `agent_h` (`schema_version` 2026-09-06.5). Git lease on `origin/main` is H’s concurrency gate for new entries. Emergency protection does not require Git.
